...
using PoojaProject.Repo;
using System;
using System.Collections.Generic;
using System.Linq;

namespace PoojaProject.Controllers
{
    [Route("[controller]")]
    [ApiController]
    ...
    {
        IQuestionsrepo ProductsRepo { get; }
        IOptionsSnapshot<Settings.Products> Settings { get; }
        IMapper Mapper { get; }
        ILogger Logger { get; }

        public QuestionsController(IQuestionsrepo productsRepo, IOptionsSnapshot<Settings.Products> options, IMapper mapper, ILogger<QuestionsController> logger)
        {
       ...
       /* /// <summary>
        ...
        {
            var newProduct = new Model.Question(id);
